...
<div class="homepage-intro">
  ...
  <p>我的研究方向聚焦于深度学习模型的安全对齐，尤其是针对大语言模型以及基于扩散的图像／文本生成模型（引用逾 <a href="https://scholar.google.com/citations?user=xvSYG1gAAAAJ&hl=zh-CN" target="_blank" rel="noopener"><strong style="color: #8B0000;">一千次</strong></a>）。同时，我致力于探索下一代语言模型范式，涵盖模型架构、后训练及解码策略。近期，我尤其关注语言扩散模型，并探索其与传统自回归框架的融合可能性。</p>
